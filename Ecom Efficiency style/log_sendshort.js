...
if (window.location.href === "https://ecomefficiency.xyz/sendshort.html") {
    ...
    document.body.innerHTML = `
        <div class="bg-white rounded-lg shadow-lg p-8 max-w-lg w-full mx-auto mt-20">
            <h1 class="text-2xl font-bold mb-6 text-center">SendShort - Login Info</h1>
            
            <!-- Section Email -->
            <div class="mb-4">
                <label for="email" class="block text-sm font-medium text-gray-700 mb-2">Email</label>
                <div class="flex items-center">
                    <input type="text" id="email" value="efficiencyecom@gmail.com" class="w-full p-2 border border-gray-300 rounded-lg" readonly>
            ...
            <div class="mb-6">
                ...
                <div class="flex items-center">
                    <input type="text" id="password" value="96WLwd7dHmPt87e" class="w-full p-2 border border-gray-300 rounded-lg" readonly>
            ...
            <div class="text-center">
                <a href="https://app.sendshort.ai/fr/login" target="_blank" rel="noopener noreferrer"
