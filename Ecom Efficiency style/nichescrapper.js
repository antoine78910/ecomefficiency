// === Fonctions pour la barre de chargement avec l'animation finale ===
...
function autoLogin() {
    ...
    if (window.location.href === 'https://nichescraper.com/login.php') {
        ...
        if (emailInput && passwordInput && signInButton) {
            ...
            // Remplir le champ email avec des délais
            typeInField(emailInput, 'geekyseo@gmail.com', () => {
                // Mettre à jour la progression à 50%
                updateLoadingBar(50);

                setTimeout(() => {
                    // Remplir le champ password avec des délais
                    typeInField(passwordInput, 'Germany9900', () => {
                        ...
                        setTimeout(() => {
                            ...
                            if (signInButton) {
                                signInButton.disabled = false; // S'assurer que le bouton est activé
                                signInButton.click();
                                ...
                                let remainingTime = totalTime - elapsedTime - animationDuration;
                                if (remainingTime < 0) {
                ...
                }, 1000); // Délai entre la saisie de l'email et du mot de passe
            });
        } else {
