...
export const toolsCatalog: ToolCatalogItem[] = [
  ...
  },
  {
    ...
    name: "Foreplay",
    category: "Ads & Spy",
    shortDescription: "Ad library and creative workflow for saving and organizing ads.",
    bestFor: ["media buyers", "creative strategists", "teams running ads"],
    aliases: ["ForePlay"],
    practicalUseCases: [
      "Collect competitor ads and tag winning hooks.",
      "Build briefs for designers/editors.",
      "Organize inspiration by product and angle.",
    ],
  },
  {
    slug: "freepik",
  ...
  {
    slug: "gemini-nanobanana",
    name: "Gemini + NanoBanana",
    category: "AI (LLM)",
    shortDescription: "AI text automation + image editing/generation workflows.",
    bestFor: ["operators", "content teams", "e-commerce founders"],
    practicalUseCases: [
      "Automate product page outlines and FAQs.",
      "Generate ad copy variations for testing.",
      "Create image variants for creatives and thumbnails.",
    ],
  },
  {
    slug: "helium10",
  ...
  },
  {
    ...
    name: "Heygen",
    category: "AI (Image/Video)",
    shortDescription: "AI video creation for UGC, avatars, and spokesperson content.",
    bestFor: ["UGC ads", "brands", "social teams"],
    practicalUseCases: [
      "Create spokesperson videos for product pages.",
      "Produce UGC-style ads with multiple scripts.",
      "Localize videos into multiple languages (if supported).",
    ],
  },
  {
    slug: "higgsfield",
    name: "Higgsfield",
    category: "AI (Image/Video)",
    shortDescription: "AI video generation and editing workflows.",
    bestFor: ["creative teams", "ads production", "content operators"],
    practicalUseCases: [
      "Generate creative variations for ad testing.",
      "Create short product visuals for socials.",
      "Speed up video ideation and iteration.",
    ],
  },
  {
    slug: "hunter",
  ...
  },
  {
    ...
    name: "SendShort",
    category: "Video",
    shortDescription: "Auto subtitles for short-form video content.",
    bestFor: ["UGC creators", "editors", "social teams"],
    practicalUseCases: [
      "Generate captions for TikTok/Reels quickly.",
      "Create multilingual subtitle versions.",
      "Speed up editing workflows for daily posting.",
    ],
  },
  {
    slug: "shophunter",
    name: "Shophunter",
    category: "Product Research",
    shortDescription: "Online store monitoring and analysis.",
    bestFor: ["dropshippers", "product researchers", "competitive analysis"],
    aliases: ["ShopHunter"],
    practicalUseCases: [
      "Track Shopify stores and new product adds.",
      "Identify rising products from competitor behavior.",
      "Benchmark pricing and offer structures.",
    ],
  },
  {
    slug: "similarweb",
  ...
  },
  {
    ...
    name: "Veo 3",
    category: "AI (Image/Video)",
    shortDescription: "AI video generation by Google (creative experiments and drafts).",
    bestFor: ["creative teams", "ads experimentation", "UGC production"],
    practicalUseCases: [
      "Generate video drafts for ad concepts.",
      "Produce creative variations for testing.",
      "Create short visuals for hooks and intros.",
    ],
  },
  {
    slug: "vmake",
    name: "Vmake AI",
    category: "Video",
    shortDescription: "AI video editing (cleanup, enhance, captions).",
    bestFor: ["video editors", "UGC teams", "social teams"],
    aliases: ["Vmake"],
    practicalUseCases: [
      "Enhance video quality and remove noise.",
      "Generate captions quickly for shorts.",
      "Turn raw UGC into ad-ready assets.",
    ],
  },
  {
    slug: "youzign",
