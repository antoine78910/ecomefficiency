...
export default function PropToolsHubDemoPage() {
  const ASSET_VERSION = "20260502-prop-demo-v1";
  return (
    <>
  ...
  100% { transform: scale(1); }
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="tools-grid relative z-10">
          ...
          <a href="https://www.semrush.com/login/" className="tool-card" target="_blank" rel="noopener noreferrer">
            <div className="tool-icon">
              <img src={`/tools-images/semrush.png?v=${ASSET_VERSION}`} alt="Semrush" />
            </div>
            <div className="tool-name">Semrush</div>
            <div className="tool-description">SEO &amp; marketing analytics platform for keywords, competitors, and traffic insights.</div>
          </a>

          <a href="https://app.neilpatel.com/en/login" className="tool-card" target="_blank" rel="noopener noreferrer">
            <div className="tool-icon">
              <img src={`/tools-images/ubersuggest.png?v=${ASSET_VERSION}`} alt="Ubersuggest" />
            </div>
            <div className="tool-name">Ubersuggest</div>
            <div className="tool-description">SEO keyword research, content ideas, and competitive analysis for growing organic traffic.</div>
          </a>
          ...
          <a href="https://www.canva.com/" className="tool-card" target="_blank" rel="noopener noreferrer">
            <div className="tool-icon">
              <img src={`/tools-images/canva.png?v=${ASSET_VERSION}`} alt="Canva" />
            </div>
            <div className="tool-name">Canva</div>
            <div className="tool-description">Graphic design platform for ads, creatives, social posts, and brand assets — fast and template-ready.</div>
          </a>

          <a href="https://www.brain.fm/login" className="tool-card" target="_blank" rel="noopener noreferrer">
            <div className="tool-icon">
              <img src={`/tools-images/brain.png?v=${ASSET_VERSION}`} alt="Brain.fm" />
            </div>
            <div className="tool-name">Brain.fm</div>
            <div className="tool-description">Focus and sleep music engineered to improve concentration and deep work sessions.</div>
          </a>

          <a href="https://app.trendtrack.io/en/login" className="tool-card" target="_blank" rel="noopener noreferrer">
            <div className="tool-icon">
              <img src={`/tools-images/trendtrack.png?v=${ASSET_VERSION}`} alt="Trendtrack" />
            </div>
            <div className="tool-name">Trendtrack</div>
            <div className="tool-description">Trend discovery and product research for ecommerce brands and media buyers.</div>
          </a>
        </div>
      </div>
    </>
