        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <Card title="Domain & branding">
            ...
            <div className="mt-4 space-y-3">
              ...
              <div className="text-xs text-gray-500">
                DNS will be provided after Stripe is connected and your workspace is provisioned.
              </div>
            </div>
          </Card>
          ...
          <Card title="Site stats">
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <div className="text-sm font-medium mb-2">Recent signups</div>
                <div className="space-y-2">
                  {(stats?.recentSignups || []).slice(0, 5).map((s, i) => (
                    <div key={i} className="text-xs text-gray-300 border border-white/10 bg-white/5 rounded-lg px-3 py-2">
                      <div className="font-medium">{s.firstName || "—"}</div>
                      <div className="text-gray-400">{s.email || "—"}</div>
                    </div>
                  ))}
                  {(!stats?.recentSignups || stats.recentSignups.length === 0) && <div className="text-xs text-gray-500">No data yet.</div>}
                </div>
              </div>
              <div>
                ...
                <div className="space-y-2">
                  ...
                  {(!stats?.recentPayments || stats.recentPayments.length === 0) && <div className="text-xs text-gray-500">No data yet.</div>}
                </div>
              </div>
            </div>
          </Card>
