        ...
        <div className="max-w-6xl mx-auto px-6 py-12 md:py-16">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <a href="https://ecomefficiency.firstpromoter.com" target="_blank" rel="noreferrer noopener">
              <button className="cursor-pointer bg-[linear-gradient(to_bottom,#9541e0,#7c30c7)] shadow-[0_4px_32px_0_rgba(149,65,224,0.70)] px-6 py-3 rounded-xl border-[1px] border-[#9541e0] text-white font-medium group h-[48px] mx-auto">
