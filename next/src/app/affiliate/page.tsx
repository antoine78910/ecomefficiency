  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 md:py-32">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-purple-500/20 border border-purple-500/30 mb-6">
              <span className="text-purple-300 text-sm md:text-base font-medium">Share EcomEfficiency</span>
            </div>
            ...
            <a href="https://ecomefficiency.firstpromoter.com" target="_blank" rel="noreferrer noopener">
              <button className="cursor-pointer bg-[linear-gradient(to_bottom,#9541e0,#7c30c7)] shadow-[0_4px_32px_0_rgba(149,65,224,0.70)] px-8 py-4 rounded-xl border-[1px] border-[#9541e0] text-white font-semibold text-lg group w-[260px] h-[60px] mx-auto hover:brightness-110 transition-all">
                <div className="relative overflow-hidden">
                  <p className="group-hover:-translate-y-8 duration-[1.125s] ease-[cubic-bezier(0.19,1,0.22,1)]">Become an affiliate</p>
                  <p className="absolute top-8 left-0 group-hover:top-0 duration-[1.125s] ease-[cubic-bezier(0.19,1,0.22,1)]">Become an affiliate</p>
                </div>
              </button>
            </a>
          </div>
      ...
      <section className="py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-y-36 md:gap-16">
            <div>
