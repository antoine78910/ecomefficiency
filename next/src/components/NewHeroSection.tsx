      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12 md:py-16 relative z-10">
        <div className="text-center">
          ...
          <div className="relative inline-flex flex-col items-center px-4 py-2 rounded-xl bg-[linear-gradient(to_bottom,rgba(149,65,224,0.18),rgba(124,48,199,0.12))] border border-[#9541e0]/40 shadow-[0_0_32px_rgba(149,65,224,0.25)] backdrop-blur-sm mb-5 overflow-visible">
            <span className="absolute -top-2 -left-2 z-10 text-[9px] px-1.5 py-0.5 rounded-full bg-[linear-gradient(135deg,#8b5cf6,#7c3aed)] text-white border border-[#a78bfa]/40 shadow-[0_0_10px_rgba(167,139,250,0.5)]">
              NEW !
            </span>
            <span className="absolute -top-2 -right-2 z-10">
              <span className="group relative inline-flex">
                <span className="inline-flex items-center justify-center w-3 h-3 rounded-full bg-white/10 text-white/80 text-[9px] border border-white/30 cursor-help">
                  !
                </span>
            ...
            <span className="text-[11px] text-purple-200/90 leading-tight">
              Unlimited Nanobanana & Seedream 4.0 generation
            </span>
          </div>
