  ...
  return (
    <footer className="bg-black border-t border-white/10 py-8 md:py-12 pl-3 pr-4 md:px-6 lg:px-8">
      <div className="w-full mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6 mb-8">
          ...
          <div className="pl-1">
            ...
            <ul className="space-y-1.5">
              ...
              <li><a href="/tools" className="text-gray-400 hover:text-white transition-colors text-xs md:text-sm">Tools</a></li>
            </ul>
          </div>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-white/10 pt-6 md:pt-8 flex flex-col md:flex-row justify-between items-center gap-2">
