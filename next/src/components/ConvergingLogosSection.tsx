...
const LOGOS: LogoData[] = [
  ...
  { src: "/tools-logos/freepik.png", alt: "Freepik", initialX: -28, initialY: 10, size: 54, delay: 0.1 },
  ...
  { src: "/tools-logos/turboscribe.png", alt: "TurboScribe", initialX: -6, initialY: 36, size: 56, delay: 0.4 },
