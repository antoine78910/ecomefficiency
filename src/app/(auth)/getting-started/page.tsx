...
export default function GettingStartedPage() {
  ...
  React.useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Cache currency for this session to avoid duplicate work (same behavior as LP)
        try {
        ...
        // Prefer server IP detection (first-party)
        try {
  ...
  const onNext = async () => {
    ...
    try {
      ...
      // Best-effort: capture payment status at this moment (for later analysis)
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className={`w-full mx-auto ${step === "setup" ? "max-w-6xl" : "max-w-2xl"}`}>
        {/* Progress pills (inspired by Foreplay) */}
              ...
              <div className="mt-10 flex flex-col items-center justify-center gap-2">
                <button
                  ...
                  className={[
                    ...
                    // No hover effect (keep same color)
            ...
            <div className="relative">
              ...
              {!pricingReady ? (
                ...
                <>
                  ...
                  {/* Community (less visible rectangle) */}
